...
(async function init() {
    d3.selectAll('.settingsButtonContainer, #settingsLogo').style('pointer-events', 'none');
    ...
    setTimeout(async () => {
        ...
        setTimeout(() => {
            ...
            d3.selectAll('.settingsButtonContainer, #settingsLogo').style('pointer-events', 'auto');
            createDeck();
        }, 1000);
    }, 1000);
})();
